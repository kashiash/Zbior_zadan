...
/*
    ...
    - jakiego typu danych mogą być tablice?
    - czy jest jakaś różnica między tablicą char a tablicą string?
    - czy musimy stworzyć metody typu void do wykonywania powyższych czynnośći, czy możemy inny, np., który zwraca int?
